...
class DatasetSplitter:
    def __init__(self, ssd_path, data_location="outputs/tiled_dataset", save_dir="outputs/split_dataset", train_ratio=0.70, test_ratio=0.15, valid_ratio=0.15, max_files=16382):
        self.ssd_path = ssd_path
        self.data_location = os.path.join(ssd_path, data_location)
        self.save_dir = os.path.join(ssd_path, save_dir)
...
if __name__ == "__main__":
    ...
    splitter = DatasetSplitter(ssd_path)
