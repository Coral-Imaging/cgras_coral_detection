...
class ImageSelector:
    ...
    def select_images(self):
        ...
        num_to_select = total_images
        if self.num_images != 'all':
            num_to_select = min(int(self.num_images), total_images)
        ...
        print(f"Selected {num_to_select} images ({(num_to_select / total_images) * 100:.2f}% of total images). Copied to {self.output_path}")
