...
""" tile_split_annotations.py
    This script only works for the CVAT annotated datasets.
...
OUTPUT_FOLDER = "test_Pdae" # normally 'train'
...
outputs_dir = os.path.join(SSD_PATH, "outputs", OUTPUT_FOLDER)
